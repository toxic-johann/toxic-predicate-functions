...
/**
 * toxic-predicate-functions v0.2.4
 * (c) 2017-2018 toxic-johann
 * Released under MIT
 * Built ad Wed Dec 12 2018 22:03:06 GMT+0800 (China Standard Time)
 */

(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
	typeof define === 'function' && define.amd ? define(['exports'], factory) :
	(factory((global.toxicPredicateFunctions = {})));
	...
	function isFile(obj) {
	  return obj && isString_1(obj.name) && isBlob(obj);
	}
	function isPromise(obj) {
	  return !!obj && (_typeof_1(obj) === "object" || typeof obj === "function") && typeof obj.then === "function";
	}
	function isPrimitive(val) {
	  return !isObject_1(val);
	}
	function isUrl(str) {
	  return isString_1(str) && !!str.match(/^((https?|ftp|rtsp|mms):\/\/)(([0-9a-z_!~*'().&=+$%-]+: )?[0-9a-z_!~*'().&=+$%-]+@)?(([0-9]{1,3}\.){3}[0-9]{1,3}|([0-9a-z_!~*'()-]+\.)*([0-9a-z][0-9a-z-]{0,61})?[0-9a-z]\.[a-z]{2,6}|localhost)(:[0-9]{1,4})?((\/?)|(\/[0-9a-z_!~*'().;?:@&=+$,%#-]+)+\/?)$/i);
	}
	function isNode(obj) {
	...
	exports.isNumber = isNumber_1;
	exports.isInteger = isInteger_1;
	exports.isBoolean = isBoolean_1;
	exports.isString = isString_1;
	exports.isDate = isDate_1;
	exports.isFunction = isFunction_1;
	exports.isError = isError_1;
	exports.isRegExp = isRegExp_1;
