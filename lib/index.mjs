...
/**
 * toxic-predicate-functions v0.3.1
 * (c) 2017-2019 toxic-johann
 * Released under MIT
 * Built ad Sun Jun 02 2019 01:01:49 GMT+0800 (China Standard Time)
 */
...
export { defined, inBrowser, isArray, isBlob, isBoolean, isChildNode, isDate, isElement, isEmpty, isError, isEvent, isFile, isFunction, isHTMLString, isInteger, isNode, isNumber, isNumeric, isObject$1 as isObject, isPosterityNode, isPrimitive, isPromise, isRegExp, isString, isUrl, isVoid };
