 ...
 * Released under MIT
 * Built ad Sat Jun 01 2019 23:02:45 GMT+0800 (China Standard Time)
 */

import _typeof from '@babel/runtime/helpers/typeof';
import { isNil, isPlainObject, isUndefined, isArray, isString, isObject as isObject$1 } from 'lodash-es';
export { isArray, isBoolean, isDate, isError, isFunction, isInteger, isNumber, isRegExp, isString } from 'lodash-es';
