...
/**
 * toxic-predicate-functions v0.1.0
 * (c) 2017 toxic-johann
 * Released under MIT
 */
...
export { isVoid, isArray, makeArray, isFunction, isObject, isNumber, isNumeric, isInteger, isEmpty, isEvent, isBlob, isFile, isDate, isString, isBoolean, isPromise, isPrimitive, isUrl, isNode, isElement, isChildNode, isPosterityNode, isHTMLString };
