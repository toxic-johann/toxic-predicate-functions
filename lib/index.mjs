...
export { defined, isVoid, isArray, isFunction, isObject, isNumber, isNumeric, isInteger, isEmpty, isEvent, isBlob, isFile, isDate, isString, isBoolean, isPromise, isPrimitive, isUrl, isNode, isElement, isChildNode, isPosterityNode, isHTMLString, isError, isRegExp };
